...
class ControllerCatalogVacancies extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_vacancies->addInformation($this->request->post);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_vacancies->editInformation($this->request->get['information_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $information_id) {
				$this->model_catalog_vacancies->deleteInformation($information_id);
			}
	...
	protected function getList() {
		...
		$vacancies_total = $this->model_catalog_vacancies->getTotalInformations();

		$results = $this->model_catalog_vacancies->getInformations($filter_data);
		...
		foreach ($results as $result) {
			$data['informations'][] = array(
				...
				'edit'           => $this->url->link('catalog/vacancies/edit', 'user_token=' . $this->session->data['user_token'] . '&information_id=' . $result['information_id'] . $url, true)
			);
		}
		...
		$data['sort_title'] = $this->url->link('catalog/vacancies', 'user_token=' . $this->session->data['user_token'] . '&sort=id.title' . $url, true);
		$data['sort_sort_order'] = $this->url->link('catalog/vacancies', 'user_token=' . $this->session->data['user_token'] . '&sort=i.sort_order' . $url, true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['information_id'])) {
			...
			$data['action'] = $this->url->link('catalog/vacancies/edit', 'user_token=' . $this->session->data['user_token'] . '&information_id=' . $this->request->get['information_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/vacancies', 'user_token=' . $this->session->data['user_token'] . $url, true);

		if (isset($this->request->get['information_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$vacancies_info = $this->model_catalog_vacancies->getInformation($this->request->get['information_id']);
		}
		...
		if (isset($this->request->post['information_description'])) {
			...
			$data['information_description'] = $this->model_catalog_vacancies->getInformationDescriptions($this->request->get['information_id']);
		} else {
		...
		if (isset($this->request->post['information_store'])) {
			...
			$data['information_store'] = $this->model_catalog_vacancies->getInformationStores($this->request->get['information_id']);
		} else {
		...
		if (isset($this->request->post['bottom'])) {
			...
			$data['bottom'] = $vacancies_info['bottom'];
		} else {
			$data['bottom'] = 0;
		}
		...
		if (isset($this->request->post['information_seo_url'])) {
			...
			$data['information_seo_url'] = $this->model_catalog_vacancies->getInformationSeoUrls($this->request->get['information_id']);
		} else {
		...
		if (isset($this->request->post['information_layout'])) {
			...
			$data['information_layout'] = $this->model_catalog_vacancies->getInformationLayouts($this->request->get['information_id']);
		} else {
		...
		} elseif (!empty($vacancies_info) && is_file(DIR_IMAGE . $vacancies_info['image'])) {
			$data['thumb'] = $this->model_tool_image->resize($vacancies_info['image'], 100, 100);
		} else {
